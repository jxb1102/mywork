		...
		<div class="col-xs-12">
			...
			<div class="row">
				<div class="col-sm-6">
					...
					<form action="<?php echo U('cangku');?>" class="form-horizontal" id="validation-form" method="post">
						<div class="form-group">
							<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="address_sheng">省份:</label>

							<div class="col-xs-12 col-sm-9">
								<div class="clearfix">
									<input type="text" name="address_sheng" id="address_sheng" class="col-xs-12 col-sm-6" value="<?php echo C('ADDRESS_SHENG');?>" />
								</div>
							</div>
						</div>
						<div class="form-group">
					<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="address_shi">市:</label>

					<div class="col-xs-12 col-sm-9">
						<div class="clearfix">
							<input type="text" name="address_shi" id="address_shi" class="col-xs-12 col-sm-6" value="<?php echo C('ADDRESS_SHI');?>" />
						</div>
					</div>
				</div>
						
				<div class="form-group">
					<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="address_add">地址:</label>

					<div class="col-xs-12 col-sm-9">
						<div class="clearfix">
							<input type="text" name="address_add" id="address_add" class="col-xs-12 col-sm-6" value="<?php echo C('ADDRESS_ADD');?>" />
						</div>
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="address_zip">邮编:</label>

					<div class="col-xs-12 col-sm-9">
						<div class="clearfix">
							<input type="text" name="address_zip" id="address_zip" class="col-xs-12 col-sm-6" value="<?php echo C('ADDRESS_ZIP');?>" />
						</div>
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="address_tel">联系电话:</label>

					<div class="col-xs-12 col-sm-9">
						<div class="clearfix">
							<input type="text" name="address_tel" id="address_tel" class="col-xs-12 col-sm-6" value="<?php echo C('ADDRESS_TEL');?>" />
						</div>
					</div>
				</div>
