...
<html>
	...
	<div class="row">
		<div class="col-sm-12">
			<form <?php if($info): ?>action="<?php echo U('articleedit');?>"
				<?php else: ?>
				action="<?php echo U('articleadd');?>"<?php endif; ?>
				...
				<div class="col-xs-12 col-sm-10">
					<div class="clearfix">
						<select name="cid" class="input-medium" id="cid">
							...
							<?php if(is_array($catelist)): $i = 0; $__LIST__ = $catelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$c): $mod = ($i % 2 );++$i;?><option value="<?php echo ($c["id"]); ?>" <?php if(($c["id"]) == $info["cid"]): ?>selected<?php endif; ?>><?php echo ($c["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
						</select>
					</div>
				</div>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-xs-12 col-sm-10">
				<div class="clearfix">
					<textarea class="col-sm-10" name="jianjie" style="height: 50px;" id="jianjie"><?php echo ($info["jianjie"]); ?></textarea>
				</div>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-xs-12 col-sm-10">
				<div class="clearfix">
					<textarea class="col-sm-10" name="content" style="height: 250px;" id="content"><?php echo ($info["content"]); ?></textarea>
				</div>
			</div>
		</div>
<div class="form-group">
	...
	<div class="col-xs-12 col-sm-10">
		<div class="clearfix">
			<?php if($info): ?><input type="hidden" name="id" value="<?php echo ($info["id"]); ?>">
				<button type="submit" class="btn btn-success btn-next no-border">确认编辑</button><a href="<?php echo U('article');?>" class="btn btn-light btn-next no-border">取消</a>
				<?php else: ?>
				<button type="submit" class="btn btn-success btn-next no-border">确认添加</button><a href="<?php echo U('article');?>" class="btn btn-light btn-next no-border">取消</a><?php endif; ?>
		</div>
	</div>
</div>
...
jQuery(function($){
		$.getScript('/Public/Common/js/kindeditor/kindeditor-min.js', function() {
						KindEditor.basePath = '/Public/Common/js/kindeditor/';
