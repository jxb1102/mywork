...
<html>
	<head>
		<meta charset="utf-8" />
		<title>登陆 - <?php echo C('DOMAIN_TITLE');?>程序管理后台</title>
					...
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							<div class="center" style="margin-top: 30px;">
								<h1>
									<span class="red"><?php echo C('DOMAIN_TITLE');?></span>
									<span class="white">程序管理后台</span>
								</h1>
								<!-- <h4 class="blue">&copy; 郑州全搜索代运系统</h4> -->
							</div>
												...
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" name="username" class="form-control" placeholder="输入邮箱" />
															<i class="icon-user"></i>
														</span>
													</label>
