...
<div class="middle">
  <div class="column1200">
    <p class="global_pic"><img src="/Public/Home/default/images/activity.jpg" width="1200" height="355" /></p>
    <div class="activity mg_T10">
      <h3><span style="color:#CF0000;">最新优惠活动</span></h3>
      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div style="width:570px;margin:15px;float:left;">
      <p class="activity_title" style="font-size:16px;">&nbsp;<?php echo ($v["list"]); ?></p>
      <dl class="activity_list">
        <dt class="left"><a href="http://<?php echo ($v["url"]); ?>" target="_blank"><img src="<?php echo ($v["pic"]); ?>" width="917" height="320"/></a></dt>
        <dd class="right"><b class="left">活动网站：</b><span class="left" style="font-size:16px;font-weight:600; color:green;"><?php echo ($v["web"]); ?></span><br /><b class="left">活动商品：</b><span class="left"><?php echo ($v["list"]); ?></span><br /><b class="left">活动详情：</b><span class="left" style="height:60px;overflow:hidden;"><?php echo ($v["content"]); ?></span><b class="left">活动时间：</b><span class="left"><?php echo ($v["time"]); ?></span><br /><a href="http://<?php echo ($v["url"]); ?>" class="mg_T10" target="_blank">去逛逛</a></dd>
      </dl>
